                            ...
                            <>
                                <div className="relative">
                                    <button
                                        ...
                                        className="inline-block rounded-sm cursor-pointer border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                                    >
                                        Masuk Sebagai
                                    </button>
                                    {isDropdownOpen && (
                                        <div className="absolute right-0 mt-2 w-48 rounded-md border border-gray-200 bg-white shadow-lg dark:border-[#3E3E3A] dark:bg-[#2c2c29] z-50">
                                            <Link
                                                href="/guru/login"
                                                className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-[#EDEDEC] dark:hover:bg-[#3E3E3A]"
                                            >
                                                Guru
                                            </Link>
                                            <Link
